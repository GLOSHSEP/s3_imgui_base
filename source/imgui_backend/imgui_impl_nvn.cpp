...
// backend impl
    ...
    bool createShaders() {
        ...
        if (false /*ImguiShaderCompiler::CheckIsValidVersion(bd->device)*/) {
            ...
            nya::fs::LoadData loadData = {
                .path = "sd:/nyaloader/ImGuiData/imgui.bin"
            };
    ...
    void updateKeyboard(ImGuiIO &io) {
        ...
        io.AddKeyEvent(ImGuiMod_Alt, nya::hid::isModifierActive(nn::hid::KeyboardModifier::LeftAlt) ||
                                     nya::hid::isModifierActive(nn::hid::KeyboardModifier::RightAlt));

        bool isAltCode = nya::hid::isModifierActive(nn::hid::KeyboardModifier::CapsLock) ||
                         nya::hid::isModifierActive(nn::hid::KeyboardModifier::Shift);
    ...
    void newFrame() {
        ...
        nya::hid::updatePadState(); // update input helper
